...
import views.HomePagePanelHoR;
import views.NhanKhauManagePanel;
import views.NhanKhauManagePanelHoR;
import views.StatisticsPanel;
import views.StatisticsPanelHoR;
import views.ThongKePanelHoR;
import views.TimKiemPanel;
import views.TimKiemPanelHoR;

/**
 *
 * @author Hai
 */
public class MainControllerHoR {
    private JFrame jfrMain;
    private JPanel root;
    private String kindSelected;
    private List<DanhMucBean> listDanhMuc;

    public MainControllerHoR(JPanel root, JFrame jfrMain) {
    ...
    public void setView(JPanel jpnItem, JLabel jlbItem, String kind) {
        ...
        switch(kind) {
                case "ToTruong":
                    view = new HomePagePanelHoR();
                    break;
                case "NhanKhau":
                    view = new NhanKhauManagePanelHoR(this.jfrMain);
                    break;
                case "HoKhau":
                    view = new StatisticsPanelHoR(this.jfrMain);
                    break;
                case "TimKiem":
                    view = new TimKiemPanelHoR(this.jfrMain);
                    break;
                case "ThongKe":
                    view = new ThongKePanelHoR(this.jfrMain);
                    break;
                //any more
                default:
                    break;
    ...
    public void setDefaultColor() {
        this.listDanhMuc.forEach((item) -> {
            if (item.getKind().equals("ToTruong")) {
...
//            jlbItem.setBackground(Color.PINK);
