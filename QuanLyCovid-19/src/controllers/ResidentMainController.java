...
public class ResidentMainController {
    ...
    public ResidentMainController(JPanel root, JFrame jfrMain) {
    ...
    public void setView(JPanel jpnItem, JLabel jlbItem, String kind) throws SQLException, ClassNotFoundException {
        ...
        switch(kind) {
                ...
                case "CapNhatThongTin":
                    view = new UpdateInfoPanel(this.jfrMain);
                    break;
                case "KhaiBaoYTe":
                    view = new HealthDeclarationPanel(this.jfrMain);
                    break;
                case "HoiDap":
                    view = new QuestionAndAnswerPanel(this.jfrMain);
                    break;
                case "ThongKe":
                    view = new StatisticsPanel(this.jfrMain);
                    break;
                //any more
                default:
                    break;
