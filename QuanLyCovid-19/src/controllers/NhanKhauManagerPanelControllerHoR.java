...
import views.infoViews.InfoJframeHoR;

/**
 *
 * @author Hai
 */
public class NhanKhauManagerPanelControllerHoR {
    ...
    public static NhanKhauBean temp;

    public NhanKhauManagerPanelControllerHoR(JPanel jpnView, JTextField jtfSearch) {
    ...
    public NhanKhauManagerPanelControllerHoR() {
    }
...
//                    System.out.print(temp.getKbyt());
                    NhanKhauBean info = nhanKhauService.getNhanKhau(temp.getChungMinhThuModel().getSoCMT());
                    InfoJframeHoR infoJframe = new InfoJframeHoR(info.toString(), parentJFrame,NhanKhauManagerPanelControllerHoR.this);
