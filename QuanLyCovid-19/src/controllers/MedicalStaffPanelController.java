...
import views.QuestionAndAnswerPanel;
 ...
 * @author Hai
 */
public class MedicalStaffPanelController {
    private JFrame jfrMain;
    private JPanel root;
    private String kindSelected;
    private List<DanhMucBean> listDanhMuc;

    public MedicalStaffPanelController(JPanel root, JFrame jfrMain) {
    ...
    // set panel for root
    public void setView(JPanel jpnItem, JLabel jlbItem, String kind) throws ClassNotFoundException {
        ...
        switch(kind) {
                case "TrangChu":
                    ...
                    break;
                case "NhanKhau":
                    view = new UpdateInfo(this.jfrMain);
                    break;
                case "HoKhau":
                    view = new MedicalManagement(this.jfrMain);
                    break;
                //any more
                default:
                    break;
            ...
            switch(kind) {
                ...
                case "NhanKhau":
                {
                    try {
                        ...
                        Logger.getLogger(MedicalStaffPanelController.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
                    break;
