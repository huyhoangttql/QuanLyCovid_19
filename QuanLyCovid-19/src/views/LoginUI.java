...
public class LoginUI extends javax.swing.JFrame {
    ...
    private void login() {
        ...
        String accessPermission = (jRadioButton1.isSelected() ? "HoR" : "") + 
                                  (jRadioButton2.isSelected() ? "R" : "") +
                                  (jRadioButton3.isSelected() ? "MS" : "");
        System.out.print(accessPermission);
        try {
            if (this.cont.login(userName, password, accessPermission)) {
                if (jRadioButton2.isSelected()){
                    dispose();
                    ResidentMainFrame mainFrame = new ResidentMainFrame();
                    mainFrame.setLocationRelativeTo(null);
                    mainFrame.setResizable(false);
                    mainFrame.setVisible(true);
                } else if (jRadioButton3.isSelected()){
                    dispose();
                    MedicalStaff mainFrame = new MedicalStaff();
                    mainFrame.setLocationRelativeTo(null);
                    mainFrame.setResizable(false);
                    mainFrame.setVisible(true);
                }
                    ...
                    dispose();
                    MainFrameHoR mainFrame1 = new MainFrameHoR();
    ...
    private void initComponents() {
        ...
        jRadioButton1.setText("Tổ trưởng");
