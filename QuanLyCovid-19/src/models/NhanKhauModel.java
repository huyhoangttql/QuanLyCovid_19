...
public class NhanKhauModel {
    ...
    private String covid19affected;

    public NhanKhauModel(){
        
    }
    
    public NhanKhauModel(String name, Date date, String gender, String personalID, 
                         String address, String phoneNumber, String email, String covid19affected){
        this.hoTen = name;
        this.namSinh = date;
        this.gioiTinh = gender;
        this.soHoChieu = personalID;
        this.diaChiHienNay = address;
        this.soDienThoai = phoneNumber;
        this.email = email;
        this.covid19affected = covid19affected;
    }
    ...
    public String getCovid19affected() {
        return covid19affected;
    }

    public void setCovid19affected(String covid19affected) {
        this.covid19affected = covid19affected;
    }
