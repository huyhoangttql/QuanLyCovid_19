...
//                nhanKhauBean.getKbyt() = new KBYT();
    ...
    public List<NhanKhauBean> statisticNhanKhau(int TuTuoi, int denTuoi, String gender, String Status) {
        List<NhanKhauBean> list = new ArrayList<>();
        ...
        String query = "SELECT * FROM nhan_khau "
                    ...
                    + denTuoi+
                    " AND nhan_khau.covid19affected LIKE N'%"+Status+"%'";
...
//        query += " ORDER BY ngayTao DESC";
         try {
            ...
            int idNhanKhau = -1;
            while (rs.next()){
                //JOptionPane.showMessageDialog(null,rs.getString("hoTen"));
                NhanKhauBean  nhanKhauBean = new NhanKhauBean();
                NhanKhauModel nhanKhau = nhanKhauBean.getNhanKhauModel();
                ChungMinhThuModel chungMinhThuModel = nhanKhauBean.getChungMinhThuModel();
                idNhanKhau = rs.getInt("idNhanKhau");
